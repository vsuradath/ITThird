...
import ContractTermsPrintView from './print/ContractTermsPrintView';
...
const ContractTermsForm: React.FC<Props> = ({ 
    onSubmit, 
    onSaveDraft,
    definition,
    initialData, 
  ...
  const formFooter = (
    <div className="flex justify-between items-center pt-4 print:hidden">
        <div>
            <span className="text-sm text-gray-500">รหัสแบบฟอร์ม ITD-2025-THP005</span>
        </div>
  ...
  return (
    <>
      ...
      <ContractTermsPrintView data={formData} definition={definition} />
    </>
  );
};
